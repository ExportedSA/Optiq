...
export async function registerTikTokAdsOAuthRoutes(app) {
    app.get("/api/integrations/tiktok-ads/connect", async (req, reply) => {
    ...
    app.get("/api/integrations/tiktok-ads/callback", async (req, reply) => {
    ...
    app.delete("/api/integrations/tiktok-ads/disconnect", async (req, reply) => {
...
//# sourceMappingURL=tiktok-ads-oauth.js.map