...
export async function registerTrackRoutes(app) {
    app.options("/track", async (req, reply) => {
    ...
    app.post("/track", async (req, reply) => {
        ...
        const siteRes = await pool.query('SELECT "id", "domain" FROM "TrackingSite" WHERE "publicKey" = $1 LIMIT 1', [parsed.data.k]);
        ...
        await pool.query(`INSERT INTO "TrackingEvent" (
        "id",
        "siteId",
        "eventId",
        "type",
