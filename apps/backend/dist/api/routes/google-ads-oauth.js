 ...
 */
export async function registerGoogleAdsOAuthRoutes(app) {
    /**
     * GET /api/integrations/google-ads/connect
     *
     * Initialize OAuth flow
     */
    app.get("/api/integrations/google-ads/connect", async (req, reply) => {
        try {
     ...
     */
    app.get("/api/integrations/google-ads/callback", async (req, reply) => {
        try {
            ...
            const customerIds = accountsData.resourceNames?.map((name) => name.replace("customers/", "")) || [];
            // Store credential
     ...
     */
    app.post("/api/integrations/google-ads/refresh", async (req, reply) => {
        try {
     ...
     */
    app.delete("/api/integrations/google-ads/disconnect", async (req, reply) => {
        try {
            const { organizationId } = req.body;
            const credential = await prisma.googleAdsCredential.findFirst({
                where: { organizationId },
...
//# sourceMappingURL=google-ads-oauth.js.map