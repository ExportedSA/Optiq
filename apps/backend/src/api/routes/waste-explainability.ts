...
import {
  getWasteExplanation,
  generateWasteExplanation,
  generateMissingExplanations,
} from "../../services/waste-explainability";
 ...
 */
export async function registerWasteExplainabilityRoutes(app: FastifyInstance) {
  /**
   ...
   */
  app.get(
    "/api/waste/explain/:wasteScoreId",
    async (req: FastifyRequest<{ Params: { wasteScoreId: string } }>, reply: FastifyReply) => {
      try {
   ...
   */
  app.post(
    "/api/waste/explain/generate-missing",
    async (req: FastifyRequest<{
