...
export interface WasteExplanation {
  ...
  performance?: {
    actualCpa?: number;
    targetCpa?: number;
    cpaDeviation?: number;  // percentage
    actualRoas?: number;
    targetRoas?: number;
    roasDeviation?: number;  // percentage
  };
 ...
 */
function fromMicros(micros: bigint | null): number | null {
 ...
 */
function generateZeroConversionsExplanation(
  wasteScore: any,
  supportingData: any,
): WasteExplanation {
 ...
 */
function generateCpaBreachExplanation(
  wasteScore: any,
  supportingData: any,
): WasteExplanation {
 ...
 */
function generateRoasBreachExplanation(
  wasteScore: any,
  supportingData: any,
): WasteExplanation {
 ...
 */
export async function generateWasteExplanation(
  wasteScoreId: string,
): Promise<WasteExplanation> {
  ...
  let explanation: WasteExplanation;
 ...
 */
async function getSupportingData(wasteScore: any): Promise<any> {
  const where: any = {
 ...
 */
export async function getWasteExplanation(
  wasteScoreId: string,
): Promise<WasteExplanation | null> {
  ...
  return {
    ruleType: explanation.ruleType as any,
    ruleName: explanation.ruleName,
    ruleDescription: explanation.ruleDescription,
    spendWindow: {
    ...
    recommendations: explanation.recommendations as any,
