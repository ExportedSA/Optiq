 ...
 * ```
 */
export type { PlatformCode, IntegrationStatus, OAuthToken, ConnectionParams, ConnectionResult, AccountMetadata, CampaignData, AdData, CostMetrics, SyncOptions, SyncResult, IntegrationCore, Integration, IntegrationConfig, IntegrationFactory, } from "./types";
...
export { IntegrationRegistry, registerIntegration, getIntegration, isPlatformSupported, getSupportedPlatforms, } from "./integration-factory";
